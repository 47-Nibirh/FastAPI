...
@app.get("/sort")
def view_sorted_students(sorted_by: str = Query(..., description="Sorted on the basis on age,class,roll,marks"),order: str = Query('asc',description="choose order: asc or desc")):
